...
import { UpdateProfileService } from "../home/update-profile/update-profile.service";
...
describe('AuthHttpInterceptor', ()=> {
    ...
    it('should add an authorization header',()=> {
        ...
        const savedUser = new User('abc@gmail.com','sampleJwtToken', new Date("3600000"));
        ...
        const selectedMember = {
          ...
          claimsSvc.submitClaim("abc@gmail.com",testForm,selectedMember).subscribe(
              claim => (
          ...
          expect (req.request.headers.get('Authorization')).toBe('Bearer sampleJwtToken');
    ...
    it ('should not add an authorization header', ()=>{
     ...
     "password": "timeLapse"
        ...
        authService.signUp(inputForm).subscribe(
