...
return [
 ...
 beforeEach(() => {
    localStorage.clear()
    const userDetail = new UserDetail( 'Rick', 'Sanchez', '1996-11-04','rick@gmail.com')
    localStorage.setItem('userDetail',JSON.stringify(userDetail));
    const userInfo = new User( "ricky@gmail.com","sampleToken",new Date("3600000"))
  ...
  it('should take value from local storage for a new signed up user', () => {
    ...
    console.log('Inside should take value from local storage for a new signed up user')
  ...
  it('should fetch all details from home service for an existing user', ()=>{
    console.log('Inside should fetch value from home service for an existing user')
    homeServiceStub.needBasicDetail = false;
  ...
  component.isNewUser = false;
   ...
   it('should fetch basic details from home service for a new user who did not complete the profile', ()=>{
       ...
       console.log('Inside should fetch basic details from home service for a new user who did not complete the profile')
       homeServiceStub.needBasicDetail = false;
       authServiceStub.isNewUser = false;
     
       spyOn(homeService, 'getProfile').and.returnValue(throwError('Email not found'))
        component.ngOnInit();
       component.isNewUser = false;
       console.log(component.rcvdProfile)
